...
<body>
    <div class="phpcoding">
        ...
        <section class="maincontent">
                ...
                <!-- php constant is a special type of variable whose value cannot be changed. -->

                <?php
                    define("GREETING", "constant is a special type of variable whose value cannot be changed.");
                    function myTest() {
                        return GREETING;
                    }
                    echo myTest();                
